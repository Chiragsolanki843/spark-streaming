...
// foreachBatch
// foreachPartition
// Using both you can do whatever you want in Spark Streaming
...
object ReceiverSystem {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val source = Source.actorRef[Car](bufferSize = 10, overflowStrategy = OverflowStrategy.dropHead) // akka.stream.scaladsl.Source
